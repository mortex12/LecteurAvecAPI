...
// audio.src=musicList[musicListIndex];
...
//-----------------------------------------------------CARD-----------------------------------------------
document.getElementById('searchBar').addEventListener('keydown',function(event) { if(event.key === 'Enter'){ 
    let urlModified = 'https://cors-anywhere.herokuapp.com/https://api.deezer.com/search?q='+document.getElementById('searchBar').value;
    // function event() {
    let input = document.getElementById('searchBar').value
    urlModified = 'https://cors-anywhere.herokuapp.com/https://api.deezer.com/search?q='+input;
